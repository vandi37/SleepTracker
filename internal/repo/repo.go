...
type User interface {
	...
	GetBirth(ctx context.Context, tx *sql.Tx, id int64) (time.Time, models.Error)
...
type Sleep interface {
	Enter(ctx context.Context, tx *sql.Tx, user_id int64, sleep_time, wake_time models.NullInt16, score int16, date time.Time) (int64, models.Error)
